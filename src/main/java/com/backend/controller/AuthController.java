...
import com.backend.services.CustomUserDetails;
...
public class AuthController {
	...
	public AuthController(UserRepository userRepository,PasswordEncoder passwordEncoder,JwtProvider jwtProvider,CustomUserDetails customUserDetails,CartService cartService) {
