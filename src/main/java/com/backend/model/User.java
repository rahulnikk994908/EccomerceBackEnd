...
public class User {
	...
	public List<PaymentInformation> getPayementInformation() {
		return payementInformation;
	}

	public void setPayementInformation(List<PaymentInformation> payementInformation) {
	...
	public User(Long id, String firstName, String lastName, String password, String email, String role, String mobile,
			List<Address> address, List<PaymentInformation> payementInformation, List<Rating> ratings,
